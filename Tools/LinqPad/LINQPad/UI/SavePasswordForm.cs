namespace LINQPad.UI
{
    ...
    internal class SavePasswordForm : BaseForm
    {
        ...
        public SavePasswordForm(string prompt, bool saveByDefault)
        {
            this.InitializeComponent();
            this.lblPrompt.Text = prompt;
            this.chkSave.Checked = saveByDefault;
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.panOKCancel.Controls.Add(this.chkSave, 1, 0);
            ...
            this.panOKCancel.Size = new Size(0x163, 0x2b);
            this.panOKCancel.TabIndex = 5;
            this.btnOK.DialogResult = DialogResult.OK;
            this.btnOK.Location = new Point(0xbf, 13);
            ...
            this.btnCancel.Location = new Point(0x114, 13);
            ...
            this.chkSave.Anchor = AnchorStyles.Left | AnchorStyles.Bottom;
            this.chkSave.AutoSize = true;
            this.chkSave.Location = new Point(3, 0x11);
            this.chkSave.Name = "chkSave";
            this.chkSave.Size = new Size(0x76, 0x17);
            ...
            this.lblPrompt.Padding = new Padding(0, 1, 0, 0);
            this.lblPrompt.Size = new Size(0x43, 0x16);
            ...
            this.textBox.Size = new Size(0x163, 0x19);
            this.textBox.TabIndex = 4;
            base.AcceptButton = this.btnOK;
            base.AutoScaleDimensions = new SizeF(7f, 17f);
            base.AutoScaleMode = AutoScaleMode.Font;
            base.CancelButton = this.btnCancel;
            base.ClientSize = new Size(0x171, 0x66);
